...
public class SignUpScreen extends BaseScreen {
	...
	public SignUpScreen(MainFrame mainFrame) {
		...
		idField.setBounds(280, 290, 140, 30);
		clearTextField(idField);
		add(idField);

		// 비밀번호 라벨
		password = new JLabel("Password");
		password.setBounds(120, 330, 140, 30);
		...
		passwordField.setBounds(280, 330, 140, 30);
		clearTextField(passwordField);
		add(passwordField);

		// 비밀번호 확인 라벨
		passwordCheck = new JLabel("Password Check");
		passwordCheck.setBounds(80, 370, 200, 30);
		...
		passwordCheckField.setBounds(280, 370, 140, 30);
		...
		signupButton.setBounds(180, 420, 130, 39);
