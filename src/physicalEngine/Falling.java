//public Falling(int x, Image fruitImage, Fruit.FruitList type, GameScreen gameScreen)추가
//wall_right, bottom 상자크기에 맞게 변셩 
//double angularVelocity = 0; // 회전 속도 double rotationAngle = 0;  // 현재 회전 각도 추가
